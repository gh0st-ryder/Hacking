...
class Solution {
    ...
    bool playerCanGetTo(Coord box, Coord player, Coord location) {
    ...
    pair<bool, Coord> getPlayerLocationToMoveBox(Coord box_at, Coord box_to) {
